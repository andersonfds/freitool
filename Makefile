...
build_arm_macos:
	...
	tar -czvf ./bin/$(PROJECT_NAME)_macOS_arm.tar.gz ./bin/macOS/arm64/$(PROJECT_NAME)
	rm -r ./bin/macOS
...
build_intel_macos:
	...
	tar -czvf ./bin/$(PROJECT_NAME)_macOS_x86.tar.gz ./bin/macOS/x86_64/$(PROJECT_NAME)
	rm -r ./bin/macOS
...
build_linux:
	...
	tar -czvf ./bin/$(PROJECT_NAME)_Linux_x86.tar.gz ./bin/Linux/x86_64/$(PROJECT_NAME)
	rm -r ./bin/Linux
...
build_windows:
	...
	tar -czvf ./bin/$(PROJECT_NAME)_Windows_x86.tar.gz ./bin/Windows/x86_64/$(PROJECT_NAME).exe
	rm -r ./bin/Windows